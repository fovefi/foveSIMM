...
text \<open> Lookup whether a given asset is relative (True) or not (False). Per default it is False.\<close>
...
text \<open> Lookup the shift of a given asset. \<close>
...
text \<open> Lookup the base level (current value) of a given asset. \<close>
...
text \<open> Lookup the shocks of a given asset. \<close>
...
text \<open> Lookup the shock type of a given asset. \<close>
...
text \<open> The following code exports the functions and defined constants to scala. \<close>
